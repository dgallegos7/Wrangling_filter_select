...
This set of data looks like it is genres of movies ranging from Action to Shorts from years 1939 up until 2002. 
...
```
The average median budget is at 6.1.

This code block shows us the mean of the movie rating at 5.9. 

The average median budget is at 
```{r}
